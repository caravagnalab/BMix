...
#'
#' @examples
plot_clusters = function(fit, data, palette = 'Set1', palette.heatmap = 'Spectral', alpha = .3, M.tarone = 1000)
{
  p = NULL
...
#'
#' @examples
plot_density = function(fit, data, coverage = 100, annotation = NULL, cex = 1, palette = 'Set1', palette.heatmap = 'Spectral', alpha = .3, M.tarone = 1000)
{
  require(VGAM)
...
#'
#' @examples
plot_model_selection = function(fit,  palette.heatmap = 'Spectral')
{
  # require(ggplot2)
  K = fit$K
